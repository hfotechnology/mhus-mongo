...
public @interface Reference {
    ...
    /**
     * @return if true, Create a proxy around the reference which will be resolved on the first
     *     method call.
     */
    boolean lazy() default false;

    /**
     * @return The name of the Mongo value to store the field. Defaults to the name of the field
     *     being annotated.
     */
