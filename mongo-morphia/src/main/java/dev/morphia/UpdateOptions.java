...
public class UpdateOptions {
    ...
    /**
     * Returns true if a new document should be inserted if there are no matches to the query
     ...
     *
     * @param isUpsert true if a new document should be inserted if there are no matches to the
     *     query filter
     * @return this
     */
     ...
     *
     * @param bypassDocumentValidation If true, allows the write to opt-out of document level
     *     validation.
     * @return this
     * @mongodb.server.release 3.2
     */
