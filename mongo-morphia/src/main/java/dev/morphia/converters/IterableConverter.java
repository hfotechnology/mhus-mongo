    ...
    public Object decode(final Class targetClass, final Object fromDBObject, final MappedField mf) {
        ...
        if (fromDBObject.getClass().isArray()) {
            ...
            for (final Object o : (Object[]) fromDBObject) {
                values.add(
                        converters.decode(
                                (subtypeDest != null) ? subtypeDest : o.getClass(), o, mf));
            }
                ...
                if (o instanceof DBObject) {
                    ...
                    if (!typeParameters.isEmpty()) {
                        ...
                        if (mappedField instanceof EphemeralMappedField) {
                            values.add(
                                    converters.decode(
                                            (subtypeDest != null) ? subtypeDest : o.getClass(),
                                            o,
                                            mappedField));
                        } else {
            ...
            values.add(
                    converters.decode(
                            (subtypeDest != null) ? subtypeDest : fromDBObject.getClass(),
                            fromDBObject,
                            mf));
        }
        ...
        if (value.getClass().isArray()) {
            ...
            if (!(value instanceof Iterable)) {
                throw new ConverterException(
                        format(
                                "Cannot cast %s to Iterable for MappedField: %s",
                                value.getClass(), mf));
            }
