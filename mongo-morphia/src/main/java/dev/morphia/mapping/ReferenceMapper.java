...
class ReferenceMapper implements CustomMapper {
    ...
    private Object createOrReuseProxy(
        ...
        final Object newProxy =
                mapper.getProxyFactory()
                        .createProxy(
                                datastore, referenceObjClass, key, anntotation.ignoreMissing());
                    ...
                    .loopOrSingle(
                            ...
                            new IterCallback<Object>() {
                                ...
                                public void eval(final Object val) {
                                    ...
                                    if (ent == null) {
                                        LOG.warn(
                                                "Null reference found when retrieving value for "
                                                        + mf.getFullName());
                                    } else {
                                        refs.add(ent);
                                    }
        ...
        if (dbVal != null) {
            if (refAnn.lazy() && LazyFeatureDependencies.assertDependencyFullFilled()) {
                ...
                m =
                        mapper.getProxyFactory()
                                .createMapProxy(
                                        datastore, m, referenceObjClass, refAnn.ignoreMissing());
            }
                            ...
                            new MapIterCallback<Object, Object>() {
                                ...
                                public void eval(final Object k, final Object val) {
                                    ...
                                    if (refAnn.lazy()
                                        ...
                                        final ProxiedEntityReferenceMap proxiedMap =
                                                (ProxiedEntityReferenceMap) map;
                                        proxiedMap.__put(
                                                objKey,
                                                refAnn.idOnly()
                                                        ? mapper.manualRefToKey(
                                                                referenceObjClass, val)
    ...
    private void readSingle(
        ...
        if (ref != null) {
            ...
            if (annotation.lazy() && LazyFeatureDependencies.assertDependencyFullFilled()) {
                resolvedObject =
                        createOrReuseProxy(datastore, mapper, fieldType, ref, cache, annotation);
            } else {
                resolvedObject =
                        resolveObject(datastore, mapper, cache, mf, annotation.idOnly(), ref);
            }
    ...
    Object resolveObject(
        ...
        if (!ignoreMissing) {
            throw new MappingException(
                    String.format(
                            "The reference (%s) could not be fetched for %s",
                            ref, mf.getFullName()));
        } else {
            return null;
        }
    ...
    void readMorphiaReferenceValues(
        ...
        if (Map.class.isAssignableFrom(paramType)) {
            ...
            reference =
                    CollectionReference.decode(datastore, mapper, mappedField, paramType, dbObject);
        } else {
