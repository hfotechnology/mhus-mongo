...
import de.mhus.karaf.mongo.api.MoManagerAdmin;
...
public class MoManagerAdminImpl extends MLog implements MoManagerAdmin {
        ...
        tracker =
                new AbstractServiceTracker<MoManagerService>(MoManagerService.class) {
                    ...
                    protected void removeService(
                            ServiceReference<MoManagerService> reference,
                            MoManagerService service) {
    ...
    public void addService(MoManagerService service) throws Exception {
        ...
        synchronized (services) {
            ...
            if (n != null) servicesByName.put(n, service);
            else log().d("MoService has no name", service);
        }
    }
    ...
    public void removeService(MoManagerService service) {
        ...
        synchronized (services) {
            ...
            String n = service.getServiceName();
            if (n != null) servicesByName.remove(service.getServiceName());
    ...
    public MoManagerService getService(String name) throws NotFoundException {
        ...
        synchronized (services) {
            ...
            if (s == null) throw new NotFoundException("MoService not found", name);
            return s;
        }
    }
