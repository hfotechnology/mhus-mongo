...
/**
 * This is a fall-through validator that looks at the type and at the class of the value and figures
 * out if they're similar enough to be used to query.
 */
        ...
        if (!type.isAssignableFrom(value.getClass())
            ...
            validationFailures.add(
                    new ValidationFailure(
                            format(
                                    "Type %s may not be queryable with value '%s' with class %s",
