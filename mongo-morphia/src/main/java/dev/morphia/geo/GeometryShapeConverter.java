...
/**
 * Converter that understands most Geometry instances are effectively just lists of either other
 * geometry objects or double coordinates. Recursively encodes and decodes Geometry objects, but
 * needs to be instantiated with a List of GeometryFactory instances that represented the hierarchy
 * of Geometries that make up the required Geometry object.
 *
 * <p>Overridden by subclasses to define exact behaviour for specific Geometry concrete classes.
 */
public class GeometryShapeConverter extends TypeConverter implements SimpleValueConverter {
    ...
    private Geometry decodeObject(
            final List mongoDBGeometry, final List<GeometryFactory> geometryFactories) {
    ...
    /**
     * Extends and therefore configures GeometryShapeConverter to provide the specific configuration
     * for converting MultiPolygon objects to and from <a
     * href="http://geojson.org/geojson-spec.html#id7">MongoDB representations</a> of the GeoJson.
     */
    ...
    /**
     * Defines a new PolygonConverter. This extends and therefore configures GeometryShapeConverter
     * to provide the specific configuration for converting Polygon objects to and from <a
     * href="http://geojson.org/geojson-spec.html#id4">MongoDB representations</a> of the GeoJson.
     */
    ...
    /**
     * Defines a new MultiLineStringConverter. This extends and therefore configures
     * GeometryShapeConverter to provide the specific configuration for converting MultiLineString
     * objects to and from <a href="http://geojson.org/geojson-spec.html#id6">MongoDB
    ...
    /**
     * Defines a new MultiPointConverter. This extends and therefore configures
     * GeometryShapeConverter to provide the specific configuration for converting MultiPoint
     * objects to and from <a href="http://geojson.org/geojson-spec.html#id5">MongoDB
     * representations</a> of the GeoJson.
     */
    ...
    /**
     * Defines a new LineStringConverter. This extends and therefore configures
     * GeometryShapeConverter to provide the specific configuration for converting LineString
     * objects to and from <a href="http://geojson.org/geojson-spec.html#id3">MongoDB
     * representations</a> of the GeoJson.
     */
    ...
    /**
     * Defines a new PointConverter. This extends and therefore configures GeometryShapeConverter to
     * provide the specific configuration for converting Point objects to and from <a
     * href="http://geojson.org/geojson-spec.html#id3">MongoDB representations</a> of the GeoJson.
     */
