...
public final class GeoNear {
     ...
     * results to those documents that fall within the specified distance from the center point.
     *
     * @return the maximum
     */
    ...
    /**
     * The num option provides the same function as the limit option. Both define the maximum number
     * of documents to return. If both options are included, the num value overrides the limit
     * value.
     *
     * @return the maximum
     */
     ...
     *
     * <p>If using a 2dsphere index, you can specify the point as either a GeoJSON point or legacy
     * coordinate pair.
     *
     * <p>If using a 2d index, specify the point as a legacy coordinate pair.
     *
     * @return the point
     */
     ...
     *
     * <p>If true, then MongoDB uses spherical geometry to calculate distances in meters if the
     * specified (near) point is a GeoJSON point and in radians if the specified (near) point is a
     * legacy coordinate pair.
     *
     * <p>If false, then MongoDB uses 2d planar geometry to calculate distance between points.
     *
     * <p>If using a 2dsphere index, spherical must be true.
     *
    ...
    /**
     * If this value is true, the query returns a matching document once, even if more than one of
     * the document's location fields match the query.
     *
     * @return true if returning only unique documents since version MongoDB 2.6: Geospatial queries
     *     no longer return duplicate results. The $uniqueDocs operator has no impact on results.
     */
    ...
    public static class GeoNearBuilder {
        ...
        /**
         * @param distanceField The output field that contains the calculated distance. To specify a
         *     field within a subdocument, use dot notation.
         * @see <a href="http://docs.mongodb.org/master/reference/glossary/#term-dot-notation">dot
         *     notation</a>
         */
         ...
         * distanceMultiplier to convert radians, as returned by a spherical query, to kilometers by
         * multiplying by the radius of the Earth.
         *
         ...
         * distance. This option is useful when a location field contains multiple locations. To
         * specify a field within a subdocument, use dot notation.
         *
         * @param includeLocations the output field that identifies the location used to calculate
         *     the distance
         * @return this
         * @see <a href="http://docs.mongodb.org/master/reference/glossary/#term-dot-notation">dot
         *     notation</a>
        ...
        /**
         * The maxDocuments option provides the same function as the limit option. Both define the
         * maximum number of documents to return. If both options are included, this value overrides
         * the limit value.
         *
        ...
        /**
         * Limits the results to the documents that match the query. The query syntax is the usual
         * MongoDB read operation query syntax.
         *
         ...
         * of the document's location fields match the query. If this value is false, the query
         * returns a document multiple times if the document has multiple matching location fields.
         * See $uniqueDocs for more information.
         *
         * @param uniqueDocuments true if only unique documents are required in the return value
         * @return this builder
         * @see <a
         *     href="http://docs.mongodb.org/master/reference/operator/query/uniqueDocs/#op._S_uniqueDocs">uniqueDocs</a>
         *     Deprecated since server version 2.6: Geospatial queries no longer return duplicate
         *     results. The $uniqueDocs operator has no impact on results.
         */
